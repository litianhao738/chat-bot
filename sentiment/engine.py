...
- keyword profiles built from the Kaggle social-media dataset
  (build with: python sentiment/build_assets.py)
"""
...
from config import SENTIMENT_SUMMARY_PATH, SENTIMENT_KEYWORDS_PATH
