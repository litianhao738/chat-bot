...
DEFAULT_INPUT_CANDIDATES = [
    "yc_detailed_data.repaired.v2.jsonl",
    "yc_detailed_data.repaired.jsonl",
    "yc_detailed_data.jsonl",
]
...
def main():
    ...
    parser.add_argument("--outdir", default="project8_kb", help="Output folder")
